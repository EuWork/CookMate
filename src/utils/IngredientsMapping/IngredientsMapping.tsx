const INGREDIENTS_MAPPING: Record<string, { color: string; image: any }> = {
  ...
  cheese: {
    color: '#FFD700',
    image: require('@/assets/ingredients/cheese.png'),
  },
  ...
  огурец: {
    color: '#32CD32',
    image: require('@/assets/ingredients/cucumber.png'),
  },
  cucumber: {
    color: '#32CD32',
    image: require('@/assets/ingredients/cucumber.png'),
  ...
  салат: {
    color: '#489f48',
    image: require('@/assets/ingredients/lettuce.png'),
  },
  lettuce: {
    color: '#489f48',
    image: require('@/assets/ingredients/lettuce.png'),
  ...
  'болгарский перец': {
    color: '#c11f38',
    image: require('@/assets/ingredients/bellPepper.png'),
  },
  'bell pepper': {
    color: '#c11f38',
    image: require('@/assets/ingredients/bellPepper.png'),
  ...
  фарш: {
    color: '#9f1b40',
    image: require('@/assets/ingredients/forcemeat.png'),
  },
  forcemeat: {
    color: '#9f1b40',
    image: require('@/assets/ingredients/forcemeat.png'),
  ...
  'бургерные булочки': {
    color: '#d8b27e',
    image: require('@/assets/ingredients/burgerBuns.png'),
  },
  'burger buns': {
    color: '#d8b27e',
    image: require('@/assets/ingredients/burgerBuns.png'),
  ...
  _default: {
    color: '#616060',
    image: require('@/assets/ingredients/default.png'),
  },
};
